...
class OrderDetailsUnitTest extends BaseUnitTest {
    ...
    void should_throw_exception_when_order_detail_id_is_duplicated() {
        ...
        OrderDetail orderDetail = new OrderDetail(1L, 1L, 1, OrderStatus.CANCELED, BigDecimal.ZERO, null);
        OrderDetail orderDetail1 = new OrderDetail(1L, 1L, 1, OrderStatus.CANCELED, BigDecimal.ZERO, null);
